exports["en-US"] = {
  ...
  "/mauj": {
    ...
    "testimony.para1": "<q><b>Mauzoun won us over with the first page of their proposal.</b> Their in-depth research, cultural references, insightful analysis, and brilliant, witty writing sealed the deal.</q>",
    "testimony.para2": "<q><b>We were not only looking for excellent writers, we were seeking strategic partners</b> who could think with us (sometimes for us), help us better understand our regional audience, engage in future planning, and who are equally invested in the success of the business. That’s exactly what the Mauzoun team is.</q>",
    "testimony.para3": "<q>They have mastered the Arabic language, are culturally tapped in, understand the ins and outs of social norms, always add their creative magic to all that they do, and are up for a challenge any day. <b>The harder the brief or ask, the more excited they get and the better the work.</b> They inspire us to up our strategy, put out better work, think harder, and act faster. They are willing to bend over backwards to get us to meet our objectives, and that kind of partnership doesn’t come easy. We are so thankful to have such an impressive group of strong, smart, and witty writers who we get to call our partners.</q>"
  },
  "/services": {
    title: "Services",
