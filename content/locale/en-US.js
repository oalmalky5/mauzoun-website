exports["en-US"] = {
  ...
  "/musaandpalm": {
    ...
    "intro.para1": "When we first met Suha Musa, she told us about her dream of opening a store that narrates the story of date fruits, and merges the essence of innovation and novelty. Ever since that moment we started envisioning that place, and we began working with Suha towards realize her dream. It's been a year since we set out on our journey together, with its course continuing to unfold. Our client, Suha Musa, is one with a clear and particular aspiration and tranquil voice, and she chooses her words with careful deliberation. When discussing Musa and Palm, she opts for the phrases “date and gift shop” and “café experience,” formulating her ideas with a distinct precision that guides us through our writing process.",
    "longStory.title1": "Long story short: four naming rounds, the final choice fell on the first suggestion.",
    "longStory.para1": "'Musa and Palm' was the first suggestion we made. What was amusing, and delightful, was that Suha wasn’t sure about the name the first time around, so she asked that we try again. Our team of writers had gladly obliged, researching anew and presenting new suggestions that could satisfy her exceptional taste. (All jokes and exaggeration aside, Suha has a refined and unique taste that delves into the details in a truly impressive manner). This is a natural process we go through with any brand naming procedure - and requested more suggestions with the following rounds. After consulting her friends and family, and upon everyone's agreement on the allure of Musa and Palm, Suha was convinced. The final approval was given, and we moved to the next stage.",
    "longStory.title2": "How we chose the tone and crafted the vocab.",
    "longStory.para2": "The process took time: in order to achieve the balance between the venerable and the beautiful, and to combine the two with innovation, our team of writers needed to study and comprehend many references. It's an imperative step in order to dive into the specifics of terminology and the artistry of language, to refine an expression wholly unique to the identity of a brand that aims to utilize innovation as a means for illustrating heritage and authenticity.",
    ...
    "process.para1": "What makes working with Musa and Palm exciting and continuously growth-oriented is that they give us the time to write, and to write well, without rushing to receive a draft, as they are fully aware of the process which precedes writing: of the research, analysis, and drafting of a specific tone. In addition to that, they are also wonderful clients who help us with sources of inspiration, as well as sharing their thoughts and listening to our suggestions with an openness and sincere interest.",
    "collab.title1": "She joined throughout the project, which clarified the bigger picture.",
    "collab.para1": "When we were working on writing the brand content, our dear Suha was sharing with us her choice of colors and selection of designs for her team’s uniforms, the brand logo, the greeting cards, etc. This was to paint a clear picture in the minds of our writers, bringing our perceptions closer to reality, and increasing our comprehension and understanding of the brand.",
    ...
    "invitation.para3": "Abundance enriches every corner of the shop: it was not only a term used in writing their content, but the principle our dear Suha treated us by. It is the principle she made certain to apply with Musa and Palm, offering date fruits generous in their ingredients, and having a flourishing relationship with kindness and generosity.",
  },
  "/services": {
    title: "Services",
