exports["en-US"] = {
  ...
  "/mauj": {
    ...
    "testimony.para1": "<q>Mauzoun won us over with the first page of the proposal they put together for us. Although there were a number of companies tendering to work with us, once we saw Mauzoun’s pitch, we stopped looking at others. Their in-depth research, cultural references, insightful analysis, and brilliant, witty writing sealed the deal. Mind you, we are not an easy client— exciting and daring, yes, but definitely not your average scope of work. As a small, startup business, we are constantly rethinking our strategy and changing our approach, and without skipping a beat, Mauzoun is on top of it, adjusting scopes and adapting the work to meet our latest needs.</q>",
    "testimony.para2": "<q>In our search for a copywriting agency, we were not only looking for excellent writers, we were seeking strategic partners who could think with us (sometimes for us), help us better understand our regional audience, engage in future planning, and who are equally invested in the success of the business. That’s exactly what the Mauzoun team is.</q>",
    "testimony.para3": "<q>They have mastered the Arabic language, are culturally tapped in, understand the ins and outs of social norms, always add their creative magic to all that they do, and are up for a challenge any day. The harder the brief or ask, the more excited they get and the better the work. They inspire us to up our strategy, put out better work, think harder, and act faster. They never hold back from contributing beyond scopes and calling us out on our BS, which we appreciate so much. They are willing to bend over backwards to get us to meet our objectives, and that kind of partnership doesn’t come easy. We are so thankful to have such an impressive group of strong, smart, and witty women who we get to call our partners.</q>"
  },
  "/services": {
    title: "Services",
