exports["en-US"] = {
  ...
  "/musaandpalm": {
    ...
    "intro.para1": "When we first met Suha Musa, the brilliant ideator of Musa & Palm, she told us about her dream of establishing an experince that the story of date fruits anew, merging the essence of innovation with novelty. Ever since, we worked with Suha towards realizing her dream. It's been a year since we set out on our journey together, with its course continuing to unfold. ",
    ...
    "longStory.para1": "Musa & Palm was the first suggestion we made. What was amusing was that Suha wasn’t sure about the name the first time around, so she asked that we try again. Our team of writers continued with the naming process. We were more than glad to do so becuase with naming, this is a more than a common occureence. Ironically, after Suha consulted her friends and family, she was met with resounding enthusiasm for the allure of Musa & Palm, and she was sold on the name.",
    "longStory.title2": "Just as the seeding blooms into the palm tree, great work takes preicous time.",
    "longStory.para2": "To balance the venerable with the beautiful, and to combine them with innovation, we needed to study and comprehend many references, namely It was an imperative step in order to refine an expression wholly unique to the identity of Musa & Palm.",
    "process.title1" : "An exchange and adaptation of words:",
    "collab.title1": " Throughout the process, Suha continued to share her creative inspirations, which calrified the bigger picture.",
    ...
    "invitation.para1": "Finally, the Musa & Palm extended an invitation to our team to visit their shop. Frrom the moment we walked in, we were captivated by the cohesive beauty of the space, which aptly reflected the brand's elegent precision. Plus, who can say no to the exquisite taste of a Sukkari date filled with decadently creamy goat cheese topped with slivers of premium sun-dired tomatoes?",
    ...
    "testimony.para2": "The Mauzoun Team is pleasant and organized. The work their do is intelligent and diligent, and they style of writing is consistent, specific, and excellent. I feel that the content Mauzoun writes is there to stay for years, without the need of revamping it anytime soon, because they always write in a timeless way and are not easily swayed by fleeting trends in writing.",
