exports["en-US"] = {
  ...
  "/portfolio": {
    ...
    "creativeWriting.title": "<div class='portfolioTitle'>Book Commissions</div>",
    ...
    "boutiquePublishing.title": "<div class='portfolioTitle'>Boutique Publishing</div>",
  ...
  "/culture": {
    ...
    "subsection.box.fifth": "Alignment with Mauzoun’s brand heart is essential to professional and personal growth.",
    ...
    "subsection.smart": "<span className='bolded'>Integrity is at the heart of our premium work.</span> Integrity is the truest form of honesty; it's choosing what’s right over what’s easy, and fully embodying our values, not just saying them.",
    "subsection.diversity": "<span className='bolded'>Diversity creates true innovation.</span> We believe that without diversity, there is no innovation. It is our responsibility to uplift diversity in our team through our hiring philosophy. This means hiring team members of different races, socioeconomic backgrounds, beliefs, ages, and more, and accepting them unconditionally, so long as they do not interfere with Mauzoun's key and moral values.",
    "subsection.important": "<span className='bolded'>Alignment with Mauzoun’s brand heart is essential to professional and personal growth.</span> Our most important investment is each team member's growth, but we can't grow with you if you're not genuinely aligned with our vision, values, and purpose. Genuine alignment with our brand heart will most certainly ensure our symbiotic growth, because your growth, personally and professionally, is always a win-win for us. Alignment is key to fulfilling this, so help us help you––share your insights honestly and empathetically and we'll surely help.",
