    ...
    return (
        ...
        <div>
            ...
            <div className={styles.firstSec}>
                ...
                <iframe width="500" height="600" src="https://www.instagram.com/p/CKqoCo5FZHM/embed" frameborder="0"></iframe>
            </div>
            ...
            <div className={styles.secondSec}>
                ...
                <iframe width="500" height="600" src="https://www.instagram.com/p/CKOLK8EF21d/embed" frameborder="0"></iframe>
                ...
                <iframe width="500" height="600" src="https://www.instagram.com/p/CEyWFKnJtrl/embed" frameborder="0"></iframe>
            </div>

            <div className={styles.thirdSec}>
                <h1 className={styles.title}>What about our tone of writing?</h1>
                <ul className={styles.list}>
                    <li>Welcome to Mauj. <s>Welcome to your home.</s></li>
                    <li>Welcome to Mauj. <s>We’ve been waiting for you.</s></li>
                    <li><s>Welcome to Mauj.</s> We’ve been waiting for you.</li>
                </ul>

                <p>Welcome to Mauj. We’re glad you came.</p>

                <p>Welcome to Mauj. We’re glad you’re riding with us.</p>
                ...
                <iframe width="500" height="600" src="https://www.instagram.com/p/CEyT727pKDG/embed" frameborder="0"></iframe>
                ...
                <iframe width="500" height="600" src="https://www.instagram.com/p/CNAf2o_lkT7/embed" frameborder="0"></iframe>
                ...
                <div className={styles.fourthSec}>
                    ...
                    <iframe width="500" height="600" src="https://www.instagram.com/p/CL1O4W3Fk3P/embed" frameborder="0"></iframe>
