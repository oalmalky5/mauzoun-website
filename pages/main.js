  ...
  return (
    ...
    <div className={styles.sidenav}>
        ...
        <div className={styles.navLinks}>
            ...
            <Link className={styles.protLink} href="portfolio">Portfolio</Link>
            <Link className={styles.jobLink} href="job">Mauzoun & You</Link>
        </div>
    ...
    <div className={styles.services}> 
        <div> 
            ...
            <span> include developing strategic content for brands and campaigns, as well as unleashing our creativities in book editing, creative writing, story doctoring, and boutique publishing. <hr/></span>  }
        </div>
    ...
    <div className={styles.approach}>
        <div> 
            ...
            <span>, balancing between Arabic and English while remaining loyal to each language and the kind of service we provide. We believe in work that is backed by a strong understanding of brand strategies, audience needs, and empathetic storytelling.<hr/></span> }
        </div>
    </div>
    ...
    <div className={styles.projects}>
        <div> 
            ...
            <span>, from innovative brands to independent authors with passion projects. You can read our tales of success in our portfolio.<hr/></span> }
        </div>
    </div>
    ...
    <div className={styles.work}>
        <div> 
            ...
            <span>, prioritizing our community as much as our clients. This is why we host an annual competition for up-and-coming writers who are developing their first-ever manuscripts. Winners are provided with free editing, marketing, and publishing services to unleash their works to the world.<hr/></span> }
        </div>
    </div>
