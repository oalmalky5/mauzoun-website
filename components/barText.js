export const barText = {
  awards: {
    ...
    ar: {
      statement:
        'نستمد إلهامنا، بصفتنا ناشرين حائزين على جوائز، من التراث الأدبي الغني في العالم العربي، ونطمح للمساهمة في إثراء مكتبات المنطقة والمشاركة في تطوير استخدام اللغات.',
      points: [
        'جائزة مسرّعة أعمال النشر، قدّمتها هيئة الأدب والنشر والترجمة التابعة لوزارة الثقافة السعودية (٢٠٢٢)',
        'مِنحة تَرْجِم، قدّمتها هيئة الأدب والنشر والترجمة التابعة لوزارة الثقافة السعودية (٢٠٢٢)',
        'مبادرة إثراء المحتوى العربي: مِنحة الترجمة (٢٠٢٣)',
      ],
    },
  },
  clientsCollaborations: {
    ...
    ar: {
      statement:
        'نخوض شراكات مع المشاريع الشيقة والأخلاقية والتي تسعى لنتائج مربحة للطرفين. نتواصل بوضوح واستمرارية ونحرص على المراسلات الرقمية المنظمة والمنجزات التي تراعي الوقت، وهذا واقع تلمسونه عند تفعيل مشروعكم، إذ نوازي بين أدق التفاصيل في ملخصكم وبين معرفتنا بأفضل الممارسات كي نضمن أفضل النتائج الممكنة، والتي نستمر في تحسينها وإياكم عبر جولتي التعديلات المجانية.',
      points: [],
    },
  },
  servicesBar: {
    ...
    ar: {
      statement:
        'حرص على أن تبقى معالجتنا للكتابات العربية والإنجليزية مخلصة لأصل كل لغة ومدعومة باستيعاب صلب للإستراتيجية والجمهور المستهدف والسرد القصصي الآسر. يمكنكم الاعتماد علينا كي نشارككم بُعد نظرنا المهني وآراءنا الصريحة لنقدم لكم الجودة الأفضل.',
      points: [],
    },
  },
  aboutBar: {
    ...
    ar: {
      statement: `
      نوازن بتكامل بين كتابة المحتوى وتكليفات الكتب والنشر المتخصص. نطمح لأن يعكس عملنا غنى اللغتين العربية والانجليزية، وتشجع إبداع الكُتّاب العرب، وتُبرز القوة الكامنة في المنشورات المميزة.
      <br></br>
      انطلاقًا من السعودية، تأسست مَوْزوْن على يد ليان عبد الشكور عام ٢٠١٨، تحقيقًا لرؤية تجلت صدفةً أثناء حضورها لبرنامج إقامة كتابية لثلاثة أشهر في مدينة لوس أنجلوس. تفاجأت ليان بسؤال غير متوقع من سائق سيارة أجرة عن هدفها الأسمى في الحياة، فكشفت لها إجابتها العفوية عن رؤيتها لمَوْزوْن، وأنشأت المؤسسة بعد ثلاثة أشهر. بفضل خبرتها المهنية الثرية في التحرير والتطوير القصصي، أدركت ندرة المحتوى الآسر والكتابة المؤثرة والكتب الجميلة في العالم العربي، فأوجدت حلًا ببساطة.
      `,
      points: [],
    },
  },
