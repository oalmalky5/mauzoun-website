...
const MobileDisabled=() => <div className={styles.mobileNotsupportedContainer}>
    ...
    Our website is currently still in its beta version, <br/>and therefore does not support mobile view. <br/>For the best experience, please view the website <br/>from a desktop browser.
    </p>
    <img className={styles.logo} src='/Mauzoun – Transparent Logo – Black-01.png' alt='Mauzoun logo'/>
</div>
